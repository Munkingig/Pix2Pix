...
#Ruta raiz
PATH = "/content/drive/MyDrive/RutasPix2Pix"
...
imgurls = !ls -1 "{INPATH}"
#with os.scandir(INPATH) as ficheros:
 #   for fichero in ficheros:
 #       imgurls.append(fichero.name)
...
np.random.seed(23) # Importante solo par el tutorial.
np.random.shuffle(randurls)
 
#Particion de train/test
